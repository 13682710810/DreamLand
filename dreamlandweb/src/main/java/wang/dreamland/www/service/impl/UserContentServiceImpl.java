...
public class UserContentServiceImpl implements UserContentService {
    ...
    public Page<UserContent> findAllByUpvoteNum(UserContent content, Integer pageNum, Integer pageSize) {
        Example e = new Example(UserContent.class);
        e.setOrderByClause("upvote_num DESC");
        PageHelper.startPage(pageNum, pageSize);//开始分页
    ...
    public Page<UserContent> findByCategory(String category, Long uid, Integer pageNum, Integer pageSize){
        ...
        userContent.setuId(uid);
        userContent.setPersonal("0");  //表示查询出非私密的文章。
