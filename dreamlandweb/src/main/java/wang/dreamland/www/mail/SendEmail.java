...
public class SendEmail {
    ...
    public static void sendEmailMessage(String email,String validateCode) {
       try {
           ...
           String from = "xx17875761028@163.com";    //发邮件的出发地（发件人的信箱）
           ...
           MyAuthenticator myauth = new MyAuthenticator(from, "gz997878755gfm");
...
//    session.setDebug(true);
           ...
           // Set the subject
           message.setSubject("你好，这封邮件是梦境网激活邮件通知");

           // Set the content
           message.setContent( "<a href=\"http://localhost:8080/dreamland/activecode?email="+email+"&validateCode="+validateCode+"\" target=\"_blank\">请于24小时内点击激活</a>","text/html;charset=gb2312");
           message.saveChanges();
